...
.. py:data:: SIP2_DATASTORE_HANDLER
    ...
    .. seealso:: :py:class:`~invenio_sip2.storage.datastore.SIP2SimpleDatastore`
    .. seealso:: :py:class:`~invenio_sip2.storage.redis.RedisSip2Datastore`
...
SIP2_DATASTORE_HANDLER = 'invenio_sip2.storage.redis:RedisSip2Datastore'
SIP2_DATASTORE_REDIS_PREFIX = 'sip2'
SIP2_DATASTORE_REDIS_URL = 'redis://localhost:6379/0'
